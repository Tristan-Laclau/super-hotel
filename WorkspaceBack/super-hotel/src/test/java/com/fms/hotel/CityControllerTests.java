...
public class CityControllerTests {
    ...
    public void testSaveAndReturnCity() throws Exception {
        //GIVEN
        City city = City.builder().name("Marseille").country("13").build();
        ...
        response.andDo(print()).andExpect(status().isCreated())
                ...
                .andExpect(jsonPath("$.department", is(city.getCountry())));
    }
    ...
    public void testGetCityByIdSuccess() throws Exception {
        //GIVEN
        City city = City.builder().name("Montpellier").country("34").build();
    ...
    public void testDeleteCity() throws Exception {
        //GIVEN
        City city = City.builder().name("City To Delete").country("18").build();
        cityService.add(city);
    ...
    public void testUpdateACity() throws Exception {
        //GIVEN
        City city = City.builder().name("MauTauBan dfzefsdf").country("Somewhere").build();
        cityService.add(city);
        City updateCity = City.builder().name("Montauban").country("82").build();
